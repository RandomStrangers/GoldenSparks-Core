...
const struct LauncherTheme Launcher_CoreTheme = {
	false,
	BitmapColor_RGB(84, 80, 0),   /* background */
	BitmapColor_RGB(102, 100, 79),   /* button border */
	BitmapColor_RGB(110, 107, 26),    /* active button */
	BitmapColor_RGB(102, 100, 79),   /* button foreground */
	BitmapColor_RGB(126, 120, 92), /* button highlight */
};
